...
clear
echo -e "\033[31m若在使用中发现问题，请及时反馈！ 仅供学习交流！请勿商业行为！谢谢合作！\033[0m"
sleep 3s
...
get_node_url(){
	...
	downloads_Url=https://download.iisat.cn
...
echo -e "\033[仅供学习交流！请勿商业行为！谢谢合作！[${panelPort}]端口\033[0m"
echo -e "=================================================================="

endTime=`date +%s`
((outTime=($endTime-$startTime)/60))
echo -e "Time consumed:\033[32m $outTime \033[0mMinute!"
echo -e "\033[31m已经安装完毕，欢迎使用！仅供学习交流！请勿商业行为！谢谢合作！ \033[0m" 
rm -rf install.sh
