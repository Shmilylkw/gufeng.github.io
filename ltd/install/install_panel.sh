...
GetSysInfo(){
	...
	echo -e ${SYS_INFO}
	echo -e "请截图以上报错信息发帖至博客：https://www.2585zy.cn 求助"
}
...
get_node_url(){
	...
	downloads_Url=https://download.iisat.cn/ltd
...
echo "
+----------------------------------------------------------------------
| 高防物理机（云服务器）-专业的云服务提供商：QQ: 878317623 (顾风)
+----------------------------------------------------------------------
| Copyright © 2015-2099 宝塔开心版（https://blog.iisat.cn/bt.html） All rights reserved.
+----------------------------------------------------------------------
...
echo -e "\033[33m若无法访问面板，请检查防火墙/安全组是否有放行面板[${panelPort}]高防物理机（云服务器）-专业的云服务提供商：QQ: 878317623 (顾风)端口\033[0m"
echo -e "=================================================================="
